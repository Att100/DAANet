...
class FPN(nn.Layer):
    def __init__(self, pretrained=True):
        ...
        #decoder
        self.up1 = Up(512, 256)
        self.updc1 = DoubleConv2D(512, 512)
        self.up2 = Up(256, 128)
        self.updc2 = DoubleConv2D(256, 256)
        self.up3 = Up(128, 64)
        self.updc3 = DoubleConv2D(128, 128)
        self.up4 = Up(64, 64)
        ...
        self.classifier_x4 = nn.Conv2D(128, 1, 3, 1, 1)
        self.classifier_x2 = nn.Conv2D(256, 1, 3, 1, 1)
